...
export const catalogProducts: Product[] = [
  ...
  defineProduct({
    slug: 'giant-ice-bucket-bag',
    name: 'Giant Ice Bucket Bag',
    description:
      'Oversized insulated ice bucket bag for large-scale catering, weddings, and corporate events.',
    categorySlug: 'glacier-bags',
    subcategorySlugs: ['giant-ice-bucket-bag'],
    industries: ['events', 'hospitality'],
    image: 'g/i/giant_ice_bucket_bag.jpg',
    materials: ['fabric'],
    minOrderQuantity: 250,
    tags: ['oversized', 'event'],
    specs: SPECS.glacierBag,
  }),
  defineProduct({
    slug: 'big-globe-bag',
    name: 'Big Globe Bag',
    description:
      'Spherical insulated bag with handle — visually striking and great for premium retail packaging.',
    categorySlug: 'glacier-bags',
    subcategorySlugs: ['big-globe-bag'],
    industries: ['retail', 'beverage', 'corporate'],
    image: 'b/i/big_globe_bag.jpg',
    materials: ['fabric'],
    minOrderQuantity: 250,
    tags: ['unique', 'retail'],
    specs: SPECS.glacierBag,
  ...
  defineProduct({
    ...
    name: 'Dog Bags',
    description:
      'Insulated pet-friendly carrier bag — niche product for pet brands and outdoor lifestyle programs.',
    categorySlug: 'glacier-bags',
    subcategorySlugs: ['dog-bags'],
    industries: ['retail', 'corporate'],
    image: 'd/o/dog_bags.jpg',
    materials: ['fabric'],
    minOrderQuantity: 250,
    tags: ['pet', 'lifestyle'],
    specs: SPECS.glacierBag,
  ...
  defineProduct({
    slug: 'wet-dry-bag-plus',
    name: 'Wet/Dry Bag Plus',
    description:
      'Dual-compartment wet/dry bag for athletic and travel programs. Insulated cold side, vented dry side.',
    categorySlug: 'glacier-bags',
    subcategorySlugs: ['wet-dry-bag-plus'],
    industries: ['retail', 'sports', 'corporate'],
    image: 'w/e/wet_-_dry_bag_plus_3.jpg',
    materials: ['fabric'],
    minOrderQuantity: 500,
    tags: ['travel', 'athletic'],
    specs: SPECS.glacierBag,
  }),

  // ===== DISPLAYS — proper VAP imagery =====
  defineProduct({
    slug: 'custom-50ml-display',
    name: 'Custom 50ml Display Stand',
    description:
      'Custom-printed 50ml mini-bottle display stand. Premium retail point-of-sale fixture.',
    categorySlug: 'vaps',
    subcategorySlugs: ['custom-50ml-displays'],
    industries: ['retail', 'beverage'],
    image: 'c/u/custom_display_stand.jpg',
    materials: ['plastic', 'cardboard'],
    minOrderQuantity: 50,
    tags: ['retail', 'pos-display', 'mini-bottles'],
    specs: { dimensions: { widthMm: 280, depthMm: 200, heightMm: 380 }, weightG: 480, leadTimeDays: { min: 28, max: 42 }, customizationOptions: ['silkscreen', 'sticker'], origin: 'Imported' },
  }),
  defineProduct({
    slug: 'display-racks',
    name: 'Custom Display Racks',
    description:
      'Branded display racks for retail floor placement. Multi-tier configurations available.',
    categorySlug: 'vaps',
    subcategorySlugs: ['custom-50ml-displays'],
    industries: ['retail', 'beverage'],
    image: 'd/i/display_stands_4.jpg',
    materials: ['plastic'],
    minOrderQuantity: 25,
    tags: ['retail', 'pos-display', 'multi-tier'],
    specs: { leadTimeDays: { min: 35, max: 56 }, customizationOptions: ['silkscreen', 'wrap'], origin: 'Imported' },
  }),
  defineProduct({
    slug: 'led-labels',
    name: 'LED Light-Up Labels',
    description:
      'Battery-powered LED labels for premium bottle activations and on-premise displays.',
    categorySlug: 'vaps',
    subcategorySlugs: ['light-up-labels'],
    industries: ['beverage', 'hospitality'],
    image: 'l/e/led_label_9.jpg',
    materials: ['plastic'],
    minOrderQuantity: 100,
    tags: ['lighting', 'pos', 'premium'],
    specs: { leadTimeDays: { min: 28, max: 42 }, customizationOptions: ['pad-print', 'silkscreen'], origin: 'Imported' },
  }),
  defineProduct({
    slug: 'neon-signs',
    name: 'Custom Neon Signs',
    description:
      'Custom-fabricated neon signs for back-bar branding and in-store displays.',
    categorySlug: 'vaps',
    subcategorySlugs: ['light-up-labels'],
    industries: ['hospitality', 'beverage', 'retail'],
    image: 'n/e/neon_3.jpg',
    materials: ['plastic'],
    minOrderQuantity: 10,
    tags: ['neon', 'premium', 'pos-display'],
    specs: { leadTimeDays: { min: 42, max: 70 }, customizationOptions: ['silkscreen'], origin: 'Imported' },
  }),
  defineProduct({
    slug: 'polar-pouch',
    name: 'Polar Pouch',
